            ...
            <form method="get" action="">
              <div class="card-body">
                ...
                <div class="form-group col-md-3">
                  ...
                  <a href="{{ url('bursar/fees_collection/collect_fees') }}" style="margin-top: 30px" class="btn btn-success">Reset</a>
                </div>
                </div>
                  ...
                  <tbody>
                    @if (!empty($getRecord))
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('bursar/fees_collection/collect_fees/add_fees/'.$value->id) }}" class="btn btn-success">Collect Fees</a>
                            </td>
                        </tr>
                        @empty 
                        <tr>
