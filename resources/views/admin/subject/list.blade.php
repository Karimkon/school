      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
            <a href="{{ url('admin/subject/add') }}" class="btn btn-primary">Add New subjects</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="card">
            ...
            <form method="get" action="">
              <div class="card-body">
                ...
                <div class="form-group col-md-3">
                  <label>Date</label>
                  <input type="text" class="form-control" name="date" value="{{ Request::get('date') }}" placeholder="Enter date">
                </div>
                
                <div class="form-group col-md-3">
                  <button class="btn btn-primary" type="submit" style="margin-top: 30px">Search</button>
                  <a href="{{ url('admin/subject/list') }}" style="margin-top: 30px" class="btn btn-success">Reset</a>
                </div>
                </div>
