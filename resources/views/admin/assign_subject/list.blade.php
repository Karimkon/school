            ...
            <form method="get" action="">
              <div class="card-body">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="subject_name" value="{{ Request::get('subject_name') }}" placeholder="Enter Class Name">
                  </div>
                <div class="form-group col-md-3">
                  <button class="btn btn-primary" type="submit" style="margin-top: 30px">Search</button>
                  <a href="{{ url('admin/assign_subject/list') }}" style="margin-top: 30px" class="btn btn-success">Reset</a>
                </div>
                </div>
