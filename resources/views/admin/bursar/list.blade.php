            ...
            <form method="get" action="">
              <div class="card-body">
                ...
                <div class="form-group col-md-3">
                  ...
                  <a href="{{ url('admin/bursar/list') }}" style="margin-top: 30px" class="btn btn-success">Reset</a>
                </div>
                </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ url('admin/bursar/edit/'.$value->id) }}" class="btn btn-primary">Edit</a>
                        <a href="{{ url('admin/bursar/delete/'.$value->id) }}" class="btn btn-danger">Delete</a>
