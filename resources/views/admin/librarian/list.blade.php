...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> Total Librarians ({{ $getRecord->total() }})</h1>
                </div>
                <div class="col-sm-6" style="text-align: right;">
                    <a href="{{ url('admin/librarian/add') }}" class="btn btn-primary">Add New librarian</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Search librarian</h3>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ url('admin/librarian/edit/'.$value->id) }}" class="btn btn-primary">Edit</a>
                        <a href="{{ url('admin/librarian/delete/'.$value->id) }}" class="btn btn-danger">Delete</a>
