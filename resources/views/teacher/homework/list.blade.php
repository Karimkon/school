        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6" style="text-align: right;">
                    <a href="{{ url('teacher/homework/studenthomework/add') }}" class="btn btn-primary">Add New Homework</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <a href="{{ url('teacher/homework/list') }}" style="margin-top: 30px" class="btn btn-success">Reset</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('teacher/homework/studenthomework/edit/'.$value->id) }}" class="btn btn-primary">Edit</a>
                                            <a href="{{ url('teacher/homework/studenthomework/delete/'.$value->id) }}" class="btn btn-danger">Delete</a>
                                            <a href="{{ url('teacher/homework/studenthomework/submitted/'.$value->id) }}" class="btn btn-success">Submitted Assignments</a>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
