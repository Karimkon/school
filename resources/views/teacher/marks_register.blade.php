            ...
            <form method="get" action="">
                <div class="card-body">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <a href="{{ url('teacher/marks_register') }}" style="margin-top: 30px" class="btn btn-success">Reset</a>
                  </div>
                  </div>
...
href="{{ url('teacher/my_exam_result/print?exam_id='.Request::get('exam_id').'&student_id='.$student->id) }}">
Print</a>   
