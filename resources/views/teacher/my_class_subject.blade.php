                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if (!empty($ClassSubject))
                                                        <span style="font-weight: bold;">{{ date('h:i A', strtotime($ClassSubject->start_time)) }}</span>
                                                        :TO: <span style="font-weight: bold;">{{ date('h:i A', strtotime($ClassSubject->end_time)) }}</span>
                                                        <br />
