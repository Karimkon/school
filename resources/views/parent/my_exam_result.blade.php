...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <center><h1><B>STUDENT'S RESULTS</B></h1></center><br />
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            
            <h1><b>Student's Name:<span style="color:blueviolet">({{ $getStudent->name }} - {{ $getStudent->last_name }})</span></b></h1>
          </div>
          ...
          <div class="col-md-12">
            <div class="card">     
              <div class="card-header">
                ...
                <a style="float: right;" class="btn btn-primary" target="_blank" 
